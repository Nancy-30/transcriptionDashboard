...
export default function ToggledMenu() {
  return (
    <div className=" h-[30rem] absolute right-0 top-10 m-2">

      <div className='p-4 flex flex-col gap-10 h-[100%] bg-slate-950 rounded-lg' >
